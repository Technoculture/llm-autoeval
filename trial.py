...
class MultipleChoiceQA(dspy.Signature):
    ...
    options = dspy.InputField(desc="The set of options in the format : A option1 B option2 C option3 D option4 where A corresponds to option1, B to option2 and so on.")
